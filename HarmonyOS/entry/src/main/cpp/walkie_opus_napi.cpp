    ...
    napi_callback_info info)
{
    ...
    if (
        ...
        OH_LOG_Print(
            ...
            WALKIE_LOG_DOMAIN,
            WALKIE_LOG_TAG,
            "Encode PCM size invalid: %{public}llu",
    ...
    napi_callback_info info)
{
    ...
    if (
        ...
        OH_LOG_Print(
            ...
            WALKIE_LOG_DOMAIN,
            WALKIE_LOG_TAG,
            "WALKIE OPUS PLC ERROR: Decoder 为空"
        );
 ...
 * Native Module Init
 *
 * 这里是整个 Native 模块的统一导出表。
 *
 * 注意：
 *
 * decodePlc 必须放在这个数组里面。
 *
 * ============================================================ */
